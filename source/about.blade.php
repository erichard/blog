...
@section('body')
    ...
    <p class="mb-6">Faisant partie de la génération 90', j'ai très tôt été attiré par les jeux vidéos et l'informatique en général. J'ai un souvenir mémorable d'après-midi passées à dicter à mon père le code de jeux pour Amstrad CPC 6128. Et c'est sur ce même Amstrad que j'ai écris mon premier programme en BASIC.</p>
    ...
    <p class="mb-6">Après 4 années de PHP maison, de PostgreSQl, de LDAP et de Fedora, je quitte le Cnam pour arriver dans l'agence Le Phare. Deux années après mon arrivée comme développeur, je suis propulsé Tech Lead, en charge de la refonte des outils de production. Je préconise le framework Symfony, dont la version 2.0, vient juste de sortir.</p>

    <p class="mb-6">A l'heure où j'écris ces lignes, je viens de fêter mes 10 ans au Phare. J'ai conçus et développé une bonne dizaine d'applications dans des secteurs variés et je suis maintenant directeur technique. Ma mission principale est de résoudre les problèmes techniques qui se mettent en travers de la route de la trentaine de personnes qui composent l'agence Le Phare.</p>
    ...
    <p class="mb-6">J'ai hâte de savoir la suite :-)</p>
